...
namespace DbFirstVidzy
{
    ...
    public partial class VidzyDbContext : DbContext
    {
        ...
        public virtual int AddVideo(string name, Nullable<System.DateTime> releaseDate, string genre, Nullable<DbFirstVidzy.Classification> classification)
        {
            ...
            var classificationParameter = classification.HasValue ?
                ...
                new ObjectParameter("Classification", typeof(DbFirstVidzy.Classification));
